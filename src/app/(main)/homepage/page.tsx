  ...
  const products = [
    {
      ...
      description:
        "Enterprise-grade cloud infrastructure and services for modern businesses",
      image: "/images/products/cloud.png",
    },
    {
      title: "DevOps Platform",
      description:
        "Streamline your development and operations with our integrated platform",
  ...
  const testimonials = [
    {
      ...
      company: "TechCorp",
      content:
        "The DevOps platform has revolutionized our development workflow. Deployment times are down 75%.",
    ...
    },
    {
      ...
      content:
        "Outstanding cloud solutions and support. Our infrastructure has never been more reliable.",
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 text-center bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto space-y-6">
          <h1 className="text-5xl font-bold leading-tight bg-clip-text text-transparent pb-2 bg-gradient-to-r from-blue-600 to-indigo-600">
            Empowering Digital Innovation
          </h1>
          <p className="text-xl text-gray-600">
            We help businesses transform, innovate, and thrive in the digital
            age through cutting-edge technology solutions and expert services
          </p>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">
              Discover our suite of enterprise solutions
            </p>
          </div>
